...
- [Agon Console8 Wiki](https://agonconsole8.github.io/agon-docs/) - Community Agon Platform documentation.
...
- [CP/M 2.2 for Agon Light (more disk images)](https://github.com/julian-rose/Agon-CPM2.2/tree/playpen) - Fork of Nihirash's CP/M 2.2 port for Agon Light with extra disk images.
- [FreeRTOS/MOS for Agon Light](https://github.com/julian-rose/FreeRTOS-for-Agon) - FreeRTOS port for the Zilog eZ80-based Agon Light (and compatibles) running MOS.
